...
def ocr_img_with_box_and_save(img_data_base64:str) -> list:
    # 调用ocr服务
    ocr_result = ocr_service(img_data_base64)
    # 保存结果
    img_result_base64 = img_with_box(ocr_result, img_data_base64)
    # 保存结果图片
    output_path = f"images/ocr_result_{time.time()}.png"
    with open(output_path, "wb") as f:
        f.write(base64.b64decode(img_result_base64))
    return ocr_result
